...
public class CredentialsOIDC {
  ...
  **/
   ...
   * @return oidcUserId
  **/
  @ApiModelProperty(value = "OIDC OP's Unique ID for this user")
  ...
  **/
  ...
  public CredentialsOIDC can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public CredentialsOIDC putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, oidcUserId, createdAt, loggedInAt, isDisabled, type, url, can);
  }
