...
public class CredentialsLDAP {
  ...
  **/
  ...
  public CredentialsLDAP can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public CredentialsLDAP putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, ldapId, ldapDn, createdAt, loggedInAt, isDisabled, type, url, can);
  }
