...
public class GitConnectionTestResult {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "A short string, uniquely naming this test")
  public String getId() {
    return id;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Either \"pass\" or \"fail\"")
   ...
   * @return message
  **/
  @ApiModelProperty(value = "Additional data from the test")
  public String getMessage() {
    return message;
  }

  public GitConnectionTestResult can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public GitConnectionTestResult putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, message, can);
  }
