...
public class CredentialsEmbed {
  ...
  **/
  @ApiModelProperty(value = "Embedder's id for a group to which this user was added during the most recent login")
  ...
  **/
  ...
  public CredentialsEmbed can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public CredentialsEmbed putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, externalUserId, externalGroupId, createdAt, loggedInAt, isDisabled, type, url, can);
  }
