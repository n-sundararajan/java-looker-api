...
public class CredentialsSaml {
  ...
  **/
  ...
  public CredentialsSaml can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public CredentialsSaml putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, samlUserId, createdAt, loggedInAt, isDisabled, type, url, can);
  }
