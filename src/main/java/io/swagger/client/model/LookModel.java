...
public class LookModel {
  ...
  **/
   ...
   * @return label
  **/
  @ApiModelProperty(value = "Model Label")
  public String getLabel() {
    return label;
  }

  public LookModel can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public LookModel putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, label, can);
  }
