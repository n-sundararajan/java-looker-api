...
public class SamlMetadataParseResult {
  ...
  **/
  ...
  public SamlMetadataParseResult can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public SamlMetadataParseResult putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(idpIssuer, idpUrl, idpCert, can);
  }
