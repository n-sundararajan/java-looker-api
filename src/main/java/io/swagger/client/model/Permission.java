...
public class Permission {
  ...
  **/
   ...
   * @return parent
  **/
  @ApiModelProperty(value = "Dependency parent symbol")
  ...
  **/
  ...
  public Permission can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public Permission putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(permission, parent, description, can);
  }
