...
public class CredentialsApi3 {
  ...
  **/
  ...
  public CredentialsApi3 can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public CredentialsApi3 putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, clientId, createdAt, isDisabled, type, url, can);
  }
