...
public class BackupConfiguration {
  ...
  **/
  ...
  public BackupConfiguration can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public BackupConfiguration putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, customS3Bucket, customS3BucketRegion, customS3Key, customS3Secret, url, can);
  }
