...
public class CredentialsTotp {
  ...
  **/
  ...
  public CredentialsTotp can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public CredentialsTotp putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(verified, createdAt, isDisabled, type, url, can);
  }
