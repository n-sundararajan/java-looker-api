...
public class ApiSession {
   ...
   * @return workspaceId
  **/
  @ApiModelProperty(value = "The id of active workspace for this session")
  ...
  public ApiSession can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public ApiSession putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(workspaceId, can);
  }
