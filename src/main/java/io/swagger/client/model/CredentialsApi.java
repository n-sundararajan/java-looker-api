...
public class CredentialsApi {
  ...
  **/
  ...
  public CredentialsApi can(Map<String, Boolean> can) {
    this.can = can;
    return this;
  }

  public CredentialsApi putCanItem(String key, Boolean canItem) {
    if (this.can == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(token, createdAt, isDisabled, type, url, can);
  }
